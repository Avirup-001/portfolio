      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <a href="mailto:avirup.banik2017@gmail.com" target={'_blank'}>Send a messege</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp className='contact-icon'/>
            <h4>WhatsApp</h4>
            <h5>+91 9073126270</h5>
            <a href="https://wa.me/919073126270" target={'_blank'}>Send a messege</a>
          </article>
          <article className="contact__option">
            <RiMessengerLine className='contact-icon'/>
            <h4>Messenger</h4>
            <h5>Avirup Banik</h5>
            <a href="#contact">Send a messege</a>
          </article>
        </div>
